    ...
    <Footer className="bg-gray-100 py-8">
      <div className="container mx-auto px-4">
        <Row gutter={[16, 16]}>
          {/* About Section */}
          <Col xs={24} md={8}>
            <h3 className="text-lg font-semibold text-primary mb-4">Về <strong className="text-blue-500">ESchool</strong></h3>
          ...
          <Col xs={24} md={8}>
            ...
            <ul className="list-none space-y-2">
              ...
              <li><a href="/" className="text-gray-600 hover:text-primary">Hệ Thống</a></li>
              <li><a href="/" className="text-gray-600 hover:text-primary">Về chúng tôi</a></li>
              <li><a href="/" className="text-gray-600 hover:text-primary">Liên hệ</a></li>
            </ul>
          </Col>
          ...
          <Col xs={24} md={8}>
            ...
            <ul className="list-none space-y-2 text-gray-600">
              <li>Đường 3 tháng 2, phường Xuân Khánh, quận Ninh Kiều, TP.Cần Thơ</li>
              <li><a href="tel://23923929210" className="hover:text-primary">+8438090909</a></li>
              <li><a href="mailto:emailaddress@domain.com" className="hover:text-primary">support@eschool.edu.vn</a></li>
            </ul>
          </Col>
        </Row>
        {/* Copyright */}
