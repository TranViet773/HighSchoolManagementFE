...
import ListClassTeachingComponent from "./DetailTeachingComponent/listClassTeachingComponent";
import ListClassAdvisorComponent from "./DetailAdvisorComponent/listClassAdvisorComponent";
  ...
  return (
    <Layout style={{ minHeight: "100vh" }}>
      ...
      <Layout style={{ padding: "20px" }}>
        <Content>
          <Segmented 
            options={["Hồ sơ cá nhân", "Hồ sơ giảng dạy", "Hồ sơ chủ nhiệm"]}
            value={selectedTab}
          ...
          {selectedTab === "Hồ sơ giảng dạy" && (
            <ListClassTeachingComponent teacherId={id} listYear={listYear} />
          )}

          {selectedTab === "Hồ sơ chủ nhiệm" && (
            <ListClassAdvisorComponent teacherId={id} listYear={listYear} />
          )}
