...
const CreateStaffPage = () => {
  ...
  const onFinish = async (values) => {
    const { lastName, firstName, email, gender, phone, doB, password } = values;
    ...
    try {
      ...
      if (data) {
        toast.success("Staff created successfully", { autoClose: 1000 });
        navigate("/admin/staff");
      }
    } catch (error) {
      toast.error("Staff creation failed!", { autoClose: 1000 });
    }
  };
  ...
  return (
    <Layout style={{ minHeight: "100vh" }}>
      ...
      <Layout style={{ padding: "20px" }}>
        ...
        >
          <Card title="Thêm Mới Nhân Viên" style={{ width: 600, marginTop: -100 }}>
            <Form
              form={form}
              layout="vertical"
              onFinish={onFinish}
